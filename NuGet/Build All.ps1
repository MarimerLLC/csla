...
try 
{
    ...
    $packages = @("Core", "ASP.NET", "ASP.NET MVC 5", "ASP.NET MVC 4", "Windows Forms", "UWP", "Windows Phone WinRT", "WPF", "Windows Runtime", "MonoAndroid", "MonoTouch", "XamarinIos", "Data EF4", "Data EF5", "Data EF6",  "Data EF7", "Templates", "UpdateValidation")  
