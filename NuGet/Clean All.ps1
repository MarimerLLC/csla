...
try 
{
    ...
    $packages = @("Core", "XamarinForms", "AspNetCore MVC", "ASP.NET", "ASP.NET MVC 5", "ASP.NET MVC 4", "UWP", "Silverlight", "Windows Forms", "WPF", "MonoAndroid", "Data EF4", "Data EF5", "Data EF6", "Data EF7", "Templates", "UpdateValidation")
