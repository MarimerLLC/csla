namespace PTServiceClient
{
  partial class MainForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      // NameLabel2
      // 
      this.NameLabel2.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ProjectInfoBindingSource, "Name", true));
      ...
      // NameLabel4
      // 
      this.NameLabel4.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ResourceInfoBindingSource, "Name", true));
      ...
      // ResourceIdLabel
      // 
      this.ResourceIdLabel.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ResourceInfoBindingSource, "Id", true));
      ...
      // ProjectIdLabel
      // 
      this.ProjectIdLabel.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ProjectInfoBindingSource, "Id", true));
      ...
      this.GroupBox2.Location = new System.Drawing.Point(602, 268);
      ...
      // 
      this.ProjectInfoDataGridView.AutoGenerateColumns = false;
      this.ProjectInfoDataGridView.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
            this.DataGridViewTextBoxColumn1,
            this.DataGridViewTextBoxColumn2});
      this.ProjectInfoDataGridView.DataSource = this.ProjectInfoBindingSource;
      this.ProjectInfoDataGridView.Location = new System.Drawing.Point(12, 42);
      this.ProjectInfoDataGridView.MultiSelect = false;
      this.ProjectInfoDataGridView.Name = "ProjectInfoDataGridView";
      this.ProjectInfoDataGridView.ReadOnly = true;
      this.ProjectInfoDataGridView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
      this.ProjectInfoDataGridView.Size = new System.Drawing.Size(277, 220);
      ...
      this.ResourceInfoDataGridView.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
            this.DataGridViewTextBoxColumn6,
            this.DataGridViewTextBoxColumn7});
      this.ResourceInfoDataGridView.DataSource = this.ResourceInfoBindingSource;
      this.ResourceInfoDataGridView.Location = new System.Drawing.Point(295, 42);
      this.ResourceInfoDataGridView.MultiSelect = false;
      this.ResourceInfoDataGridView.Name = "ResourceInfoDataGridView";
      this.ResourceInfoDataGridView.ReadOnly = true;
      this.ResourceInfoDataGridView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
      this.ResourceInfoDataGridView.Size = new System.Drawing.Size(300, 220);
      ...
      this.Controls.Add(this.ProjectInfoDataGridView);
      this.Controls.Add(this.ResourceInfoDataGridView);
      this.Name = "MainForm";
    ...
    internal System.Windows.Forms.BindingSource RoleInfoBindingSource;
    ...
    internal System.Windows.Forms.BindingSource ResourceInfoBindingSource;
    ...
    internal System.Windows.Forms.DataGridView ProjectInfoDataGridView;
