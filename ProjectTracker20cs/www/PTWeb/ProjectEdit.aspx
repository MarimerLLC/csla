...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
      ...
      <br />
      <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="536px" AutoGenerateRows="False" DataSourceID="ProjectDataSource" AllowPaging="True" DataKeyNames="Id" OnItemDeleted="DetailsView1_ItemDeleted">
        <Fields>
