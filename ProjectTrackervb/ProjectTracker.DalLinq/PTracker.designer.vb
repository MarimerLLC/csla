...
Partial Public Class Assignment
	...
	<Association(Name:="Role_Assignment", Storage:="_Role1", ThisKey:="Role", IsForeignKey:=true)>  _
	...
	<Association(Name:="Project_Assignment", Storage:="_Project", ThisKey:="ProjectId", IsForeignKey:=true)>  _
	...
	<Association(Name:="Resource_Assignment", Storage:="_Resource", ThisKey:="ResourceId", IsForeignKey:=true)>  _
...
Partial Public Class Role
	...
	<Association(Name:="Role_Assignment", Storage:="_Assignments", OtherKey:="Role")>  _
...
Partial Public Class Project
	...
	<Association(Name:="Project_Assignment", Storage:="_Assignments", OtherKey:="ProjectId")>  _
	Public Property Assignments() As EntitySet(Of Assignment)
		Get
			Return Me._Assignments
		End Get
...
Partial Public Class Resource
	...
	<Association(Name:="Resource_Assignment", Storage:="_Assignments", OtherKey:="ResourceId")>  _
	Public Property Assignments() As EntitySet(Of Assignment)
		Get
			Return Me._Assignments
		End Get
