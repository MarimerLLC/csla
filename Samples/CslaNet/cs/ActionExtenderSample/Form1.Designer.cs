namespace Sample
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Sample usage of CSLA Action Extender, demonstrating how buttons can be extended t" +
				"o automate CSLA actions.";
			// 
			// label2
			// 
			...
			this.label2.Text = "Sample usage of BindingSourceHelper and BindingSourceNode components, demonstrati" +
				"ng how toolbar buttons can incorporate functionality.";
			// 
			// Form1
			// 
