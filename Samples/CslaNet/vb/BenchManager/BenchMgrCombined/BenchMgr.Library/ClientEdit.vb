...
#Region " Factory Methods "
  ...
  Public Shared Function NewClient() As ClientEdit

    Return DataPortal.Create(Of ClientEdit)()

  End Function

  Public Shared Function GetClient(ByVal item As SalesService.ClientData) As ClientEdit

    Return New ClientEdit(item)
  ...
  Private Sub New(ByVal item As SalesService.ClientData)
    Me.New()
    Fetch(item)
  End Sub
...
#Region " Data Access "
  ...
  Private Sub Fetch(ByVal item As SalesService.ClientData)
