...
#Region " Business Methods "
  ...
  Public Property Ended() As String
    Get
      Return GetPropertyConvert(Of SmartDate, String)(EndedProperty)
    End Get
    Set(ByVal value As String)
      SetPropertyConvert(Of SmartDate, String)(EndedProperty, value)
    End Set
  End Property
...
#Region " Data Access "
  ...
  Private Overloads Sub DataPortal_Fetch(ByVal criteria As SingleCriteria(Of Project, Guid))
    ...
    Using ctx = ContextManager(Of ProjectTracker.DalLinq.PTrackerDataContext).GetManager(ProjectTracker.DalLinq.Database.PTracker)
      ...
      LoadPropertyConvert(Of SmartDate, Date?)(StartedProperty, data.Started)
      LoadPropertyConvert(Of SmartDate, Date?)(EndedProperty, data.Ended)
