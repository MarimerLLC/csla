...
The solution requires Visual Studio 2012, SQL Server Express 2012, 
.NET 4.5, Silverlight 5, ASP.NET MVC 3, and WinRT (Windows 8).

The solution requires CSLA 4 version 4.5 (required assemblies are in the
