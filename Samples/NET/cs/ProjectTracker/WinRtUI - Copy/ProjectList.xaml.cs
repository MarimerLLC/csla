...
namespace WinRtUI
{
  ...
  /// </summary>
  public sealed partial class ProjectList : WinRtUI.Common.LayoutAwarePage
  {
    public ProjectList()
    {
    ...
    private async void SaveProject(object sender, RoutedEventArgs e)
    {
      ...
      var vm = (ViewModel.ProjectEditViewModel)ctl.DataContext;
      this.Progress.IsIndeterminate = true;
      await vm.SaveAsync();
      this.Progress.IsIndeterminate = false;
      await new Windows.UI.Popups.MessageDialog("Save completed", "Project").ShowAsync();
    }
