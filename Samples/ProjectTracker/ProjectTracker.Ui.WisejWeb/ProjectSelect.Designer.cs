namespace PTWisej
{
  partial class ProjectSelect
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.GetListButton = new Wisej.Web.Button();
      this.NameTextBox = new Wisej.Web.TextBox();
      this.NameLabel = new Wisej.Web.Label();
      this.ProjectListListBox = new Wisej.Web.ListBox();
      this.projectListBindingSource = new Wisej.Web.BindingSource(this.components);
    ...
    internal Wisej.Web.Button GetListButton;
    internal Wisej.Web.TextBox NameTextBox;
    internal Wisej.Web.Label NameLabel;
    internal Wisej.Web.ListBox ProjectListListBox;
    ...
    private Wisej.Web.BindingSource projectListBindingSource;
  }
}