...
namespace Csla.Axml
{
  ...
  {
    private ApplicationContext CslaApplicationContext { get; set; }

    /// <summary>
    /// Creates an instance of the type.
    /// </summary>
    /// <param name="applicationContext"></param>
    protected ActivityBase(ApplicationContext applicationContext)
    {
      CslaApplicationContext = applicationContext ?? throw new System.ArgumentNullException(nameof(applicationContext));
    }
    ...
    protected byte[] SerializeModelForParameter()
    {
      return this.SerializeModelForParameter(this.viewModel.Model);
    }
    ...
    /// <returns>An array of bytes that contains the serialized model.</returns>
    protected byte[] SerializeModelForParameter(object model)
    {
      return SerializationFormatterFactory.GetFormatter(CslaApplicationContext).Serialize(model);
    }
    ...
    {
      return SerializationFormatterFactory.GetFormatter(CslaApplicationContext).Deserialize(parameter);
    }
  }
}