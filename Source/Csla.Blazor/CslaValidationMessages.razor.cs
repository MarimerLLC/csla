...
namespace Csla.Blazor
{
  ...
  public class CslaValidationMessageBase<PropertyType> : ComponentBase, IDisposable
  {
    ...
    /// </summary>
    [Parameter]
    public string WrapperId { get; set; } = "wrapper";

    /// <summary>
    /// Gets or sets the wrapper class
    /// </summary>
    [Parameter]
    public string WrapperClass { get; set; } = "validation-messages";

    /// <summary>
    /// Gets or sets the error class
    /// </summary>
    [Parameter]
    public string ErrorClass { get; set; } = "text-danger";

    /// <summary>
    /// Gets or sets the warning class
    /// </summary>
    [Parameter]
    public string WarningClass { get; set; } = "text-warning";

    /// <summary>
    /// Gets or sets the info class
    /// </summary>
    [Parameter]
    public string InfoClass { get; set; } = "text-info";

    /// <summary>
    /// Gets or sets the error wrapper class
    /// </summary>
    [Parameter]
    public string ErrorWrapperClass { get; set; } = "error-messages";

    /// <summary>
    /// Gets or sets the warning wrapper class
    /// </summary>
    [Parameter]
    public string WarningWrapperClass { get; set; } = "warning-messages";

    /// <summary>
    /// Gets or sets the info wrapper class
    /// </summary>
    [Parameter]
    public string InfoWrapperClass { get; set; } = "information-messages";
