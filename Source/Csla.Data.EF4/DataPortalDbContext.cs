...
namespace Csla.Data.EF4
{
  ...
  public partial class DataPortalDbContext : DbContext
  {
    ...
    public DataPortalDbContext(string connection) : base(connection)
    {
    }

    public DataPortalDbContext(DbCompiledModel model) : base(model)
    {
    }

    public DataPortalDbContext(string database, DbCompiledModel model) : base(database, model)
    {
    }
