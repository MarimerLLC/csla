...
namespace Csla.Iosui
{
  ...
  public abstract class ViewControllerBase<T, Z> : UIViewController where T : ViewModel<Z>
  {
    ...
    protected ViewControllerBase(ApplicationContext applicationContext)
    {
    ...
    {
      return SerializationFormatterFactory.GetFormatter(ApplicationContext).Serialize(model);
    }
    ...
    {
      return SerializationFormatterFactory.GetFormatter(ApplicationContext).Deserialize(parameter);
    }
  }
}