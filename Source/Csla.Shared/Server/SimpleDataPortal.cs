  ...
  public class SimpleDataPortal : IDataPortalServer
  {
      ...
      Type objectType, object criteria, DataPortalContext context, bool isSync)
    {
      ...
      try
      {
        ...
        {
          MethodCaller.ThrowIfAsyncMethodOnSyncClient(isSync, target, "DataPortal_Create");

          await obj.CallMethodTryAsync("DataPortal_Create").ConfigureAwait(false);
        }
        else
        {
          MethodCaller.ThrowIfAsyncMethodOnSyncClient(isSync, target, "DataPortal_Create", criteria);
    ...
    public async Task<DataPortalResult> Fetch(Type objectType, object criteria, DataPortalContext context, bool isSync)
    {
      ...
      try
      {
        ...
        if (criteria is EmptyCriteria)
        {
          MethodCaller.ThrowIfAsyncMethodOnSyncClient(isSync, target, "DataPortal_Fetch");

          await obj.CallMethodTryAsync("DataPortal_Fetch").ConfigureAwait(false);
        }
        else
        {
          MethodCaller.ThrowIfAsyncMethodOnSyncClient(isSync, target, "DataPortal_Fetch", criteria);
      ...
      try
      {
        ...
        if (busObj != null)
        {
          if (busObj.IsDeleted)
          {
            if (!busObj.IsNew)
            {
              MethodCaller.ThrowIfAsyncMethodOnSyncClient(isSync, target, "DataPortal_DeleteSelf");
          ...
          else
          {
            if (busObj.IsNew)
            {
              MethodCaller.ThrowIfAsyncMethodOnSyncClient(isSync, target, "DataPortal_Insert");
            ...
            {
              MethodCaller.ThrowIfAsyncMethodOnSyncClient(isSync, target, "DataPortal_Update");
        ...
        else if (obj is Core.ICommandObject)
        {
          ...
          MethodCaller.ThrowIfAsyncMethodOnSyncClient(isSync, target, "DataPortal_Execute");
    ...
    public async Task<DataPortalResult> Delete(Type objectType, object criteria, DataPortalContext context, bool isSync)
    {
      ...
      try
      {
        ...
        MethodCaller.ThrowIfAsyncMethodOnSyncClient(isSync, target, "DataPortal_Delete", criteria);
