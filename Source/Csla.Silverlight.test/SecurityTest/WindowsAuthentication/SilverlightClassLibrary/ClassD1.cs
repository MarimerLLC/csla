...
{
  [Serializable()]
  public class ClassD1 : BusinessBase<ClassD1>
  {
    ...
    {
      AuthorizationRules.AllowCreate(typeof(ClassD1), "invalid");
      AuthorizationRules.AllowEdit(typeof(ClassD1), "invalid");
      AuthorizationRules.AllowDelete(typeof(ClassD1), "invalid");
    }
  }
}
