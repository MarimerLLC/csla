...
{
  /// <summary>
  /// Factory Proxy Configuration container
  /// </summary>
  public class FactoryProxyConfig
  {
    /// <summary>
    /// Set the object factory loader type in your own bootstrapper.
    /// </summary>
    public static string ObjectFactoryLoader { get; set; }
  }
  ...
  public class FactoryProxy<T> : IDataPortalProxy<T> where T : IMobileObject
  {
    ...
    public static IObjectFactoryLoader FactoryLoader
    {
      get
      {
        ...
        {
          if (!string.IsNullOrEmpty(FactoryProxyConfig.ObjectFactoryLoader))
            _factoryLoader =
              (IObjectFactoryLoader)Activator.CreateInstance(Type.GetType(FactoryProxyConfig.ObjectFactoryLoader, true));
          else
    ...
    {
      _userState = null;
      var obj = FactoryLoader.GetFactory(_attribute.FactoryTypeName);  
    ...
    {
      var factory = FactoryLoader.GetFactory(_attribute.FactoryTypeName);  
    ...
    public void BeginExecute(T command, object userState)
    {
      ...
      MethodCaller.CallMethod(obj, _attribute.ExecuteMethodName, command, handler);
    }
