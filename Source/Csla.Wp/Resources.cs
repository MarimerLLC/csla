...
namespace Csla.Properties
{
  ...
  public static class Resources
  {
    ...
    public static string BrokenRulesMergeException
    {
      get
      {
        return "Merge only allowed on custom collection objects";
      }
    }
    ...
    public static string CannotHaveMemberEqualsMemberInAnExpression
    {
      get
      {
        return "Cannot have 'member' == 'member' in an expression";
      }
    }
    ...
    public static string CanReadAuthorizationRuleDescription
    {
      get
      {
        return "You are not authorized to read this field";
      }
    }
    ...
    public static string CanWriteAuthorizationRuleDescription
    {
      get
      {
        return "You are not authorized to write to this field";
      }
    }
    ...
    public static string ExpressionTypeNotSupportedToObtainValue
    {
      get
      {
        return "The expression type {0} is not supported to obtain a value";
      }
    }
    ...
    public static string GetIdValueCantBeNull
    {
      get
      {
        return "GetIdValue must not return Nothing";
      }
    }
    ...
    public static string InvalidRuleMethodException
    {
      get
      {
        return "Invalid rule method (instance methods of the target object not allowed)";
      }
    }
    ...
    public static string ParentSetException
    {
      get
      {
        return "Parent value can only be set for child objects";
      }
    }
    ...
    public static string PrimitiveTypeRequired
    {
      get
      {
        return "Type parameter must be a primitive type";
      }
    }
    ...
    public static string UnRegisteredPropertyException
    {
      get
      {
        return "Can not use unregistered property. Call RegisterProperty() for property {0}";
      }
    }
    ...
    public static string ValidationRulesException
    {
      get
      {
        return "Validation rule {1} failed in property {0}";
      }
    }
