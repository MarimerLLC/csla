...
namespace Csla.Test.PropertyGetSet
{
  ...
  public class EditableGetSet : EditableGetSetBase<EditableGetSet>
  {
    ...
    {
      get => GetProperty<string>(FieldBackedStringProperty, _fieldBackedString);
    ...
    public int F02
    {
      get => GetProperty<int>(F02Property, _f02);
    ...
    public string F03
    {
      get => GetProperty<string>(F03Property, _f03);
    ...
    public string F04
    {
      get => GetPropertyConvert<Csla.SmartDate, string>(F04Property, _F04);
    ...
    public bool F05
    {
      get => GetProperty<bool>(F05Property, _f05);
    ...
    public string F06
    {
      get => GetPropertyConvert<object, string>(F06Property, _F06);
    ...
    public bool ManagedStringFieldDirty => FieldManager.IsFieldDirty(ManagedStringFieldProperty);

    private static Csla.PropertyInfo<int> M02Property = RegisterProperty(typeof(EditableGetSet), new Csla.PropertyInfo<int>("M02"));
    public int M02
    {
      get => GetProperty<int>(M02Property);
    ...
    public string M03
    {
      get => GetProperty<string>(M03Property);
    ...
    public string M04
    {
      get => GetPropertyConvert<Csla.SmartDate, string>(M04Property);
    ...
    public string M07
    {
      get => GetPropertyConvert<object, string>(M07Property);
    ...
    public EditableGetSet ManagedChild => LazyGetProperty(ManagedChildProperty, () => GetDataPortal<EditableGetSet>().Create());
    ...
    public ChildList ManagedChildList => LazyGetProperty(ManagedChildListProperty, () => GetDataPortal<ChildList>().Create());
    ...
    {
      get => LazyGetProperty(LazyChildProperty, () => GetDataPortal<ChildList>().Create());
