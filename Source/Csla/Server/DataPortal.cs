...
namespace Csla.Server
{
    ...
    public class DataPortal : IDataPortalServer
    {
          ...
          Type objectType, object criteria, DataPortalContext context)
        {
            ...
            {
                throw new DataPortalExceptionHandler().ToDataPortalException(objectType, criteria, "DataPortal.Create", ex);
            }
            finally
            {
        ...
        public DataPortalResult Fetch(Type objectType, object criteria, DataPortalContext context)
        {
            ...
            {
                throw new DataPortalExceptionHandler().ToDataPortalException(objectType, criteria, "DataPortal.Fetch", ex);
            }
            finally
            {
                ClearContext(context);
        ...
        public DataPortalResult Delete(Type objectType, object criteria, DataPortalContext context)
        {
            ...
            {
                throw new DataPortalExceptionHandler().ToDataPortalException(objectType, criteria, "DataPortal.Delete", ex);
            }
            finally
            {
                ClearContext(context);
