...
namespace Csla.Server
{
    ...
    public class FactoryDataPortal : IDataPortalServer
    {
        ...
        public DataPortalResult Create(Type objectType, object criteria, DataPortalContext context)
        {
            ...
            {
                throw new DataPortalExceptionHandler().ToDataPortalException(objectType, criteria, context.FactoryInfo.CreateMethodName, ex);
            }
        }
        ...
        public DataPortalResult Fetch(Type objectType, object criteria, DataPortalContext context)
        {
            ...
            {
                throw new DataPortalExceptionHandler().ToDataPortalException(objectType, criteria, context.FactoryInfo.FetchMethodName, ex);
            }
        }
        ...
        public DataPortalResult Update(object obj, DataPortalContext context)
        {
            ...
            {
                throw new DataPortalExceptionHandler().ToDataPortalException(obj.GetType(), obj, null, methodName, ex);
            }
        }
        ...
        public DataPortalResult Delete(Type objectType, object criteria, DataPortalContext context)
        {
            ...
            {
                throw new DataPortalExceptionHandler().ToDataPortalException(objectType, criteria, context.FactoryInfo.DeleteMethodName, ex);
            }
        }
