...
namespace Csla.Server
{
  ...
  /// </summary>
  [Transaction(TransactionOption.Required, Isolation = System.EnterpriseServices.TransactionIsolationLevel.ReadUncommitted)]
  ...
  public class ServicedDataPortalReadUncommitted : ServicedComponent, IDataPortalServer
  {
    ...
    [AutoComplete(true)]
    public Task<DataPortalResult> Update(Core.ICslaObject obj, DataPortalContext context, bool isSync)
    {
