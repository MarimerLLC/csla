    ...
    public class SimpleDataPortal : IDataPortalServer
    {
          ...
          Type objectType, object criteria, DataPortalContext context)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new DataPortalExceptionHandler().ToDataPortalException(objectType, outval, criteria, "DataPortal.Create", ex);
            }
        ...
        public DataPortalResult Fetch(Type objectType, object criteria, DataPortalContext context)
        {
            ...
            catch (Exception ex)
            {
                ...
                object outval = null;
                if (obj != null) outval = obj.Instance;
                throw new DataPortalExceptionHandler().ToDataPortalException(objectType, outval, criteria, "DataPortal.Fetch", ex);
            }
        }
        ...
        public DataPortalResult Update(object obj, DataPortalContext context)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new DataPortalExceptionHandler().ToDataPortalException(obj.GetType(), obj, null, "DataPortal.Update", ex);
            }
        }
        ...
        public DataPortalResult Delete(Type objectType, object criteria, DataPortalContext context)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new DataPortalExceptionHandler().ToDataPortalException(objectType, obj, null, "DataPortal.Delete", ex);
            }
        }
