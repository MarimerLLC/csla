...
namespace Csla.Test.Serialization
{
  ...
  public class SerializationTests
  {
    ...
    public void TestSerializationNames()
    {
      ...
      var assemblyName = typeof(BinaryReaderWriterTestClass).Assembly.GetName();
      var expected = $"Csla.Test.Serialization.BinaryReaderWriterTestClass, {assemblyName.Name}, Version={assemblyName.Version}, Culture=neutral, PublicKeyToken=93be5fdc093e4c30";
      Assert.AreEqual(expected, AssemblyNameTranslator.GetSerializationName(typeof(BinaryReaderWriterTestClass), true));
    }
