	...
	public sealed class IsOperationMethodPublicAnalyzerTests
	{
		...
		public async Task AnalyzeWhenClassIsNotStereotype()
		{
			await IsOperationMethodPublicAnalyzerTests.RunAnalysis(
				$@"Targets\{nameof(IsOperationMethodPublicAnalyzerTests)}.{(nameof(IsOperationMethodPublicAnalyzerTests.AnalyzeWhenClassIsNotStereotype))}.cs", 
				0);
		}
		...
		{
			await IsOperationMethodPublicAnalyzerTests.RunAnalysis(
				$@"Targets\{nameof(IsOperationMethodPublicAnalyzerTests)}.{(nameof(IsOperationMethodPublicAnalyzerTests.AnalyzeWhenClassIsStereotypeAndMethodIsNotADataPortalOperation))}.cs",
				0);
		}
		...
		{
			await IsOperationMethodPublicAnalyzerTests.RunAnalysis(
				$@"Targets\{nameof(IsOperationMethodPublicAnalyzerTests)}.{(nameof(IsOperationMethodPublicAnalyzerTests.AnalyzeWhenClassIsStereotypeAndMethodIsADataPortalOperationThatIsNotPublic))}.cs",
				0);
		}
		...
		{
			await IsOperationMethodPublicAnalyzerTests.RunAnalysis(
				$@"Targets\{nameof(IsOperationMethodPublicAnalyzerTests)}.{(nameof(IsOperationMethodPublicAnalyzerTests.AnalyzeWhenClassIsStereotypeAndMethodIsADataPortalOperationThatIsPublicAndClassIsNotSealed))}.cs",
		...
		{
			await IsOperationMethodPublicAnalyzerTests.RunAnalysis(
				$@"Targets\{nameof(IsOperationMethodPublicAnalyzerTests)}.{(nameof(IsOperationMethodPublicAnalyzerTests.AnalyzeWhenClassIsStereotypeAndMethodIsADataPortalOperationThatIsPublicAndClassIsSealed))}.cs",
