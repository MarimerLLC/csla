...
Public Class EditableRootParent
  ...
  Private Sub Create()
    ...
    Dim listDataPortal As IChildDataPortal(Of EditableChildList) = ApplicationContext.GetRequiredService(Of IChildDataPortal(Of EditableChildList))()
    LoadProperty(ChildListProperty, listDataPortal.CreateChild())
    Dim itemDataPortal As IChildDataPortal(Of EditableChild) = ApplicationContext.GetRequiredService(Of IChildDataPortal(Of EditableChild))()
  ...
  Private Sub Fetch(ByVal id As Integer)
    ' TODO: load values 
    Dim listDataPortal As IChildDataPortal(Of EditableChildList) = ApplicationContext.GetRequiredService(Of IChildDataPortal(Of EditableChildList))()
    LoadProperty(ChildListProperty, listDataPortal.FetchChild(Nothing))
    Dim itemDataPortal As IChildDataPortal(Of EditableChild) = ApplicationContext.GetRequiredService(Of IChildDataPortal(Of EditableChild))()
    LoadProperty(ChildProperty, itemDataPortal.FetchChild(Nothing))
  End Sub
