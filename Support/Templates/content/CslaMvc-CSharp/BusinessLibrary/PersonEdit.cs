...
namespace CslaMvc.BusinessLibrary
{
  ...
  public class PersonEdit : BusinessBase<PersonEdit>
  {
    ...
    [Insert]
    private void Insert([Inject]CslaMvc.DataAccess.IPersonDal dal)
    {
      using (BypassPropertyChecks)
      {
    ...
    [Update]
    private void Update([Inject]CslaMvc.DataAccess.IPersonDal dal)
    {
      using (BypassPropertyChecks)
      {
        var data = new DataAccess.PersonEntity
    ...
    [DeleteSelf]
    private void DeleteSelf([Inject]CslaMvc.DataAccess.IPersonDal dal)
    {
      Delete(ReadProperty(IdProperty), dal);
    }

    [Delete]
    private void Delete(int id, [Inject]CslaMvc.DataAccess.IPersonDal dal)
    {
      dal.Delete(id);
    }
