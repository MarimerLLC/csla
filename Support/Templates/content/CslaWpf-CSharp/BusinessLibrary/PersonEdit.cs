...
namespace CslaWpf.BusinessLibrary
{
  ...
  public class PersonEdit : BusinessBase<PersonEdit>
  {
    ...
    [Fetch]
    private void Fetch(int id, [Inject]CslaWpf.DataAccess.IPersonDal dal)
    {
      var data = dal.Get(id);
    ...
    [Insert]
    private void Insert([Inject]CslaWpf.DataAccess.IPersonDal dal)
    {
      using (BypassPropertyChecks)
      {
    ...
    [Update]
    private void Update([Inject]CslaWpf.DataAccess.IPersonDal dal)
    {
      using (BypassPropertyChecks)
      {
        var data = new DataAccess.PersonEntity
    ...
    [DeleteSelf]
    private void DeleteSelf([Inject]CslaWpf.DataAccess.IPersonDal dal)
    {
      Delete(ReadProperty(IdProperty), dal);
    }

    [Delete]
    private void Delete(int id, [Inject]CslaWpf.DataAccess.IPersonDal dal)
    {
      dal.Delete(id);
    }
