...
namespace $rootnamespace$
{
  ...
  public class $safeitemname$ : BusinessBase<$safeitemname$>
  {
    ...
    public static $safeitemname$ NewSwitchableObject()
    {
      return DataPortal.Create<$safeitemname$>();
    }

    public static $safeitemname$ GetSwitchableObject(int id)
    {
    ...
    internal static $safeitemname$ NewSwitchableChild()
    {
      return DataPortal.CreateChild<$safeitemname$>();
    }

    internal static $safeitemname$ GetSwitchableChild(object childData)
    {
