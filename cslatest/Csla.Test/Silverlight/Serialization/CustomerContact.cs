...
namespace cslalighttest.Serialization
{
  ...
  public sealed class CustomerContact : BusinessBase<CustomerContact>, IEquatable<CustomerContact>
  {
    ...
    private static PropertyInfo<string> Property_FirstName = RegisterProperty(new PropertyInfo<string>("FirstName", "First Name"));
    ...
    private static PropertyInfo<string> Property_LastName = RegisterProperty(new PropertyInfo<string>("LastName", "Last Name"));
