...
Namespace Csla
  ...
  ''' </remarks>
  <Serializable()> _
  <System.ComponentModel.TypeConverter(GetType(Core.TypeConverters.SmartDateConverter))> _
...
#Region " Conversion Functions "
    ...
    Public Shared Function StringToDate( _
      ...
      Else
        Throw New ArgumentException(Csla.Resources.StringToDateException)
      End If
    ...
    Private Shared Function TryStringToDate(ByVal value As String, ByVal emptyValue As EmptyValue, ByRef result As Date) As Boolean
      ...
      Else
        Select Case LCase(Trim(value))
          Case Csla.Resources.SmartDateT, Csla.Resources.SmartDateToday, "."
            result = Now
            Return True

          Case Csla.Resources.SmartDateY, Csla.Resources.SmartDateYesterday, "-"
            result = DateAdd(DateInterval.Day, -1, Now)
            Return True

          Case Csla.Resources.SmartDateTom, Csla.Resources.SmartDateTomorrow, "+"
            result = DateAdd(DateInterval.Day, 1, Now)
            Return True
        End Select
      End If
...
#Region " Manipulation Functions "
    ...
    Public Function CompareTo(ByVal obj As Object) As Integer _
      ...
      Else
        Throw New ArgumentException(Csla.Resources.ValueNotSmartDateException)
      End If
