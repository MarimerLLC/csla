namespace Sample
{
	partial class OrderMaint
	{
		...
		private void InitializeComponent()
		{
			...
			this.cslaActionExtender1.SetDisableWhenClean(this.btnSaveNew, false);
			...
			this.cslaActionExtender1.SetDisableWhenClean(this.btnSaveClose, false);
			...
			this.cslaActionExtender1.SetDisableWhenClean(this.btnCancel, false);
			...
			this.cslaActionExtender1.SetDisableWhenClean(this.btnClose, false);
