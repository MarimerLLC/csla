Partial Public Class MainForm
  ...
  Private Sub TestButton_Click(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles TestButton.Click

    MessageBox.Show(Library.ClientList.Test)
