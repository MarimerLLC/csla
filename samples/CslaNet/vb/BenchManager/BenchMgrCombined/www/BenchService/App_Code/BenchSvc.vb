...
Public Class BenchSvc
  Implements IBenchSvc

  Public Function GetConsultantList(ByVal benchOnly As Boolean) As ConsultantData() Implements IBenchSvc.GetConsultantList
  ...
  Public Function GetConsultant(ByVal id As Integer) As ConsultantData Implements IBenchSvc.GetConsultant
  ...
  Public Function UpdateConsultant(ByVal consultant As ConsultantUpdateData) As ConsultantData Implements IBenchSvc.UpdateConsultant
  ...
  Public Function GetProjectList(ByVal consultantId As Integer) As ProjectData() Implements IBenchSvc.GetProjectList
  ...
  Public Sub UpdateProjects(ByVal consultantId As Integer, ByVal projects() As ProjectUpdateData) Implements IBenchSvc.UpdateProjects
